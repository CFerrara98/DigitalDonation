...
public class TesserinoRepositoryIT {
    ...
    public void salvaTesserino() {
        ...
        tesserino.setNumeroMatricola(1234);
        tesserino.setDonatoreUtenteCodiceFiscale("CPVMCQ67P64H724I");
     ...
     *
     * @test {@link TesserinoRepository#findDonatoreBydonatoreUtenteCodiceFiscale(String)}
     *
     ...
     */
    @Test
    public void findDonatoreBydonatoreUtenteCodiceFiscale(){

        // Controlla che ogni tesserino inserito per il test sia presente su database
        // restituendolo in base al codice fiscale dell'utente
        Tesserino tesserinoSalvato = tesserinoRepository.findDonatoreBydonatoreUtenteCodiceFiscale(tesserino.getDonatoreUtenteCodiceFiscale());
