                                        ...
                                        <div class="p-5">
                                            ...
                                            <div class="card shadow mb-4">
                                                <div class=" m-0 card-header py-3">
                                                    <h6 class="m-0 font-weight-bold text-primary h6">Dati donatore:</h6>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${TesserinoLuogoNascitaError == null}">
                                                                    <form:input type="text" class="form-control form-control-user" id="luogo" placeholder="es. Salerno" path="luogoNascita"/>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <form:input type="text" class="form-control form-control-user is-invalid" id="luogo" placeholder="es. Salerno" path="luogoNascita"/>
                                                ...
                                                <p style="color:#4e73df;">Email: </p>
                                                    <c:choose>
                                                        <c:when test="${TesserinoEmailError == null}">
                                                            <form:input type="email" class="form-control form-control-user" id="email" placeholder="es. angela@live.com" path="email"/>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <form:input type="email" class="form-control form-control-user is-invalid" id="email" placeholder="es. angela@live.com" path="email"/>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${TesserinoAltreIndicazioniError == null}">
                                                            <form:textarea class="textarea form-control" id="altreIndicazioni" placeholder="es. Nessuna" rows="4" path="altreIndicazioni"/>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <form:textarea class="textarea form-control" id="altreIndicazioni" placeholder="es. Nessuna"  rows="4" path="altreIndicazioni"/>
                                            ...
                                            <div class="card shadow mb-4">
                                                <div class=" m-0 card-header py-3">
                                                    <h6 class="m-0 font-weight-bold text-primary h6">Dati tessera:</h6>
                                                </div>
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${TesserinoNumeroMatricolaError == null}">
                                                                    <form:input type="text" class="form-control form-control-user" id="numeroMatricola" placeholder="es. 43243" path="numeroMatricola"/>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <form:input type="text" class="form-control form-control-user is-invalid" id="numeroMatricola" placeholder="es. Salerno" path="numeroMatricola"/>
                                                        ...
                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${TesserinoNumeroTesseraError == null}">
                                                                    <form:input type="text" class="form-control form-control-user" id="numeroTessera" placeholder="es. 65475" path="numeroTessera"/>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <form:input type="text" class="form-control form-control-user is-invalid" id="numeroTessera" placeholder="es. 26543" path="numeroTessera"/>
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${TesserinoDataRilascioError == null}">
                                                                <form:input type="date" class="form-control form-control-user" id="data" placeholder="es. 04/01/2022" path="dataRilascio"/>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <form:input type="date" class="form-control form-control-user is-invalid" id="data" placeholder="es. 04/01/2022" path="dataRilascio"/>
                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="col-sm-12 mb-3 mb-sm-0">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${TesserinoDataNascitaError == null}">
                                                                <form:input type="date" class="form-control form-control-user" id="data" placeholder="es. 04/01/2022" path="dataDonazione"/>
                                                            </c:when>
                                                            <c:otherwise>
