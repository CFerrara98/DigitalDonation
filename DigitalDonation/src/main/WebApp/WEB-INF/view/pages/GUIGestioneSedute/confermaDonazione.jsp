                    ...
                    <div class="container mt-6" style="padding-top:60px;">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Conferma
                                    donazione</h6>
                            </div>
                            <div class="card-body">
                                <div class="text-center">
                                    <h1>&nbsp;</h1>
                                    <h4 class=" mb-4" style="text-align: center">Confermi l'avvenuta
                                        donazione?</h4>
                                    <h1>&nbsp;</h1>
                                    ...
                                    <div class="container">
                                        ...
                                        <form:form action="./salvataggioDonazione" method="post"
                                                   modelAttribute="confermaDonazioneForm"
                                                   cssClass="user"
                                                   enctype="application/x-www-form-urlencoded">

                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <label for="tipoDonazione" style="color:#4e73df;">Inserire
                                                    il tipo di donazione del donatore: </label>
            ...
            <footer id="footer" class="sticky-footer bg-white">
                <div align="center" class="container my-auto">
                    ...
                    <div class="copyright" style="color:#6C757D;">
                        ...
                        Il trattamento dei dati personali è svolto nel rispetto dei diritti sulla
                        privacy in base alla legge n. 675 del 31 dicembre 1996
                        <br> e dei diritti per condivisione dei dati personali come stabilito dalla
                        legge n 675/96 del 2003.
                        <br>
