...
public class TesserinoFormException extends Exception{
     ...
     */
    public TesserinoFormException(String messaggio) {
        super(messaggio);
    }
     ...
     */
    public TesserinoFormException(String target, String messaggio) {
        super(messaggio);
        this.target = target;
    }
