...
/**
 * Eccezione generata in caso di parametri non validi durante l'inserimento dei campi inerenti la conferma donazione form.
 *
 * @author Mattia Sapere
 */
public class ConfermaDonazioneFormException extends Exception {
     ...
     */
    private static final String MESSAGGIO_DEFAULT = "Form conferma donazione non valido";

    /**
     * Genera un'eccezione che riporta come messaggio il messaggio di default:
     * {@link #MESSAGGIO_DEFAULT}.
     */
    public ConfermaDonazioneFormException() {
     ...
     */
    public ConfermaDonazioneFormException(String messaggio) {
        super(messaggio);
    }
     ...
     */
    public ConfermaDonazioneFormException(String target, String messaggio) {
        super(messaggio);
        this.target = target;
    }
